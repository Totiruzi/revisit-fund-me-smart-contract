...
contract FundMeTest is Test {
    ...
    function testFailsWithoutEnoughEth() public {
        vm.expectRevert();
        // this test should fail if no fund is sent
        fundMe.fund();
    }
    ...
    function testWithdrawWithASingleFunder() public funded {
       ...
       /** Calculating gas spent on transaction
        uint256 gassEnd = gasleft();
        uint256 gasUsed = (gasStart - gassEnd) * tx.gasprice;
